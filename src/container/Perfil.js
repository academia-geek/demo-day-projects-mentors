            ...
            <div class='container m-5'>
                <div class="row justify-content-between">
                    ...
                    <div class="col-4 text-center">
                        ...
                        <img src='https://files.lafm.com.co/assets/public/2020-01/abogado.jpg' style={{ width: '80%' }} />
                        <h2>Juan Pablo</h2>
                        <p><FaStarHalfAlt /> Opiniones (+57)</p>
                        <h5>Tarifa horaria:      $70.00 Hr</h5>
                        <h5>Tiempo de respuesta: 4 Hr</h5>
                        <h5>Numeros de alumnos: +50</h5>
                        <button className="btn btn-outline-success bg-success text-black m-2" type="submit">Agendar</button>
                    </div>
                </div>
            </div>
            <Footer/>
