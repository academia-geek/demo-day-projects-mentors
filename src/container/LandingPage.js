        ...
        <div>
            <div class="container col-xl-10 col-xxl-8 px-4 py-4">
                <div class="row align-items-center g-lg-5 py-5">
                    ...
                    <div class="col-md-10 mx-auto col-lg-5">
                        <img className='w-100' src='https://res.cloudinary.com/dmdu8u7wo/image/upload/v1648349074/Digital_presentation-pana_hzaqzg.png' />
                    </div>
                </div>
            </div>
            ...
            <div className='container row mx-5'>
                <div class=" col card border-success mx-5">
                    <div class="card-header bg-transparent border-success text-center"><img className='w-50' src='https://res.cloudinary.com/dmdu8u7wo/image/upload/v1648482956/proyecto-final/Video_call-bro_vsidud.png'></img></div>
                    <div class="card-body text-success">
                        <h5 class="card-title">Mentorías personalizadas</h5>
                ...
                <div class="col card border-success mx-5">
                    <div class="card-header bg-transparent border-success text-center"><img className='w-50' src='https://res.cloudinary.com/dmdu8u7wo/image/upload/v1648483017/proyecto-final/Online_learning-pana_qlubim.png'></img></div>
                    <div class="card-body text-success">
                        <h5 class="card-title">Paga por sesión</h5>
                        <p class="card-text">Paga únicamente por sesiones individuales, sin contratos ni suscripciones.</p>
                    </div>
                </div>
                <div class="col card border-success mx-5">
                    <div class="card-header bg-transparent border-success text-center"><img className='w-50' src='https://res.cloudinary.com/dmdu8u7wo/image/upload/v1648483058/proyecto-final/Online_world-amico_iba9hm.png'></img></div>
                    <div class="card-body text-success">
                        <h5 class="card-title">Dónde quieras, cuándo quieras</h5>
